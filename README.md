...
# 자소서 도우미 - ja-so-seo-do-u-mi v0.1

채용공고/JD, 자기소개서 문항, 글자수 제한, 거친 초안만 붙여넣으면 **기업 제출용 자기소개서**로 다시 다듬는 Codex 스킬입니다.

단순히 문장을 예쁘게 고치는 도구가 아닙니다. 이 스킬은 문항이 묻는 의도, JD의 주요업무와 자격요건, 초안 속 실제 경험, 글자수 제한을 함께 읽고 **문항에 답하는 구조**로 재작성합니다. 동시에 자소서 특유의 공식 문체, 뻔한 클리셰, 근거 없는 역량 주장, 회사 칭찬 템플릿, 면접에서 방어하기 어려운 과장 표현을 줄입니다.
...
자소서 도우미는 이런 문제를 단계별 워크플로우로 나눠 처리합니다. 먼저 입력을 파싱하고, JD와 문항을 해석한 뒤, 초안의 약점을 진단하고, 제출용 문장으로 재작성하고, 마지막에 글자수와 사실 보존을 검증합니다.
...
2. **문항 우선** - 멋진 문장보다 문항에 정확히 답하는 구조를 먼저 만듭니다.
3. **JD 기반** - 주요업무와 자격요건을 우선 반영하고, 우대사항과 인재상은 보조로만 씁니다.
4. **근거 중심** - 책임감, 소통능력, 문제해결력 같은 추상어를 행동과 결과로 바꿉니다.
5. **JD 과적합 방지** - JD 용어를 나열하지 않고, 초안 속 실제 경험과 연결되는 말만 남깁니다.
6. **제출 안전성** - 글자수, 회사명, 직무명, 블라인드 위반 가능성, 면접 방어 가능성을 점검합니다.
...
| `submission-auditor`           | 글자수, 사실 보존, JD 연결, 면접 방어 가능성 검증      |
